...
2. Replace the Line 29 proxy (line29_anchor := karish) with the actual Line 29 endpoint from the UKHO / Lebanese army study, if a machine-readable source is found.
